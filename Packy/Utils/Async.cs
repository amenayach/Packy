...
namespace Packy.Utils
{
    ...
    public class Async
    {
        ...
        public static void GetDataAsync<T>(DataByThreadWorker<T>.GetDataDelegate GetDataFunc,
            DataByThreadWorker<T>.CallCompleted DataCompletedDelegate)
        {
        ...
        public static void DoAsync(DataByThreadWorker<object>.DoSomething doSomethingIns,
            DataByThreadWorker<object>.DoSomething doNextthingIns)
        {
